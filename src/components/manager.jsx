...
const Manager = () => {
  return (
    <div className='max-w-2xl h-auto  mx-auto my-20 text-white font-black '>
      ...
      <button className='lg:w-[500px] mx-auto my-10 text-2xl lg:text-5xl text-black bg-white border-1 border-blue-600 p-4 rounded-xl flex justify-center hover:rounded-2xl hover:bg-slate-400'>
        <div> <lord-icon
